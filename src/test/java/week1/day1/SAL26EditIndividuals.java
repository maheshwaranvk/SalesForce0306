...
WebDriverManager.chromedriver().setup();
		...
		js.executeScript("arguments[0].click()", driver.findElementByXPath("(//div[@class='slds-grid'])[1]"));
	
		js.executeScript("arguments[0].click()", driver.findElementByXPath("//button[@name='refreshButton']"));
		js.executeScript("arguments[0].click()", driver.findElementByXPath("(//lightning-icon[@class='slds-icon-utility-down slds-icon_container']/lightning-primitive-icon)[2]"));
